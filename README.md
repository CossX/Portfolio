...
Я интересуюсь искусственным интелектом, в частности машинным обучением и компьютерным зрением. Ниже - примеры проектов, выполненных мной.
...
Нейронная сеть, которая узнает на фото Дональда Трампа. Построенна с использованием библиотеки dlib. 
